// Can be deleted for this project
...
// import 'package:web_dashboard/instance/mqttClientFactoryWeb.dart';
...
// final cognitoUser = CognitoUser('terencegan98@gmail.com', userPool);
// final authDetails = AuthenticationDetails(
//   username: 'terencegan98@gmail.com',
...
// late final MqttBrowserClient clientWeb;
// late final MqttServerClient clientServer;
...
//       // Check connection status
//       if (clientServer.connectionStatus!.state ==
...
//         clientWeb.subscribe(topic, MqttQos.atLeastOnce);
...
//       } else {
//         debugPrint(
//             'ERROR MQTT client connection failed - disconnecting, state is ${clientWeb.connectionStatus!.state}');
//         clientWeb.disconnect();
//         return 'Disconnected';
//       }
//     } else {
...
//       } else {
//         debugPrint(
//             'ERROR MQTT client connection failed - disconnecting, state is ${clientServer.connectionStatus!.state}');
//         clientServer.disconnect();
//         return 'Disconnected';
//       }
//     }
...
//       clientWeb.unsubscribe(topicName);
//     } else {
//       debugPrint('Unsubcribing $topicName');
//       clientServer.unsubscribe(topicName);
//     }
//   }
// }
